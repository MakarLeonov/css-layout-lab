    ...
    <div className="flex-1 overflow-auto p-6">
      <div className="max-w-3xl mx-auto flex flex-col gap-6">
        ...
        <div>
          ...
          <p className="text-[12px] font-mono text-slate-500 dark:text-slate-200 mt-1">
        ...
        {/* Info banner */}
        <div className="flex gap-3 p-4 rounded-xl bg-brand-50 dark:bg-brand-950/20 border border-brand-200 dark:border-brand-900 text-[12px] font-mono text-brand-700 dark:text-brand-440">
