...
const DEFAULTS: FlexboxState = {
  ...
  items: [
    ...
    { id: 3, label: '3', grow: 0, shrink: 1, basis: 'auto', order: 0, alignSelf: 'auto', bg: '#06b6d4' },
    { id: 4, label: '4', grow: 0, shrink: 1, basis: 'auto', order: 0, alignSelf: 'auto', bg: '#10b981' },
    { id: 5, label: '5', grow: 0, shrink: 1, basis: 'auto', order: 0, alignSelf: 'auto', bg: '#f59e0b' },
  ],
}
